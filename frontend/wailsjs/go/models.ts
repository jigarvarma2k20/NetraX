...
export namespace sqlite {
	...
	export class RepeaterRequest {
	    id: number;
	    name: string;
	    request: domain.HTTPRequestDTO;
	    response?: domain.HTTPResponseDTO;
	    modified_at: string;
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.request = this.convertValues(source["request"], domain.HTTPRequestDTO);
	        this.response = this.convertValues(source["response"], domain.HTTPResponseDTO);
