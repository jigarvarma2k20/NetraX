        ...
        <div className="flex h-full w-full items-center justify-center overflow-y-auto bg-background-dark custom-scrollbar">
            <div className="w-full max-w-3xl px-6 py-8">
                ...
                <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div className="glass rounded-xl border border-white/6 p-6 transition-colors hover:bg-white/2">
                        ...
                        <p className="mb-4 text-sm leading-relaxed text-text-secondary">
                            Configure your browser or operating system to route HTTP/HTTPS traffic through the NetraX proxy. By default, NetraX binds to <code className="rounded bg-black/30 px-1.5 py-0.5 text-primary">127.0.0.1:8080</code>.
                        </p>
                    </div>
                ...
                <div className="flex items-start gap-3 rounded-xl border border-accent-blue/10 bg-accent-blue/5 p-4">
                    <ShieldAlert className="mt-0.5 shrink-0 text-accent-blue" size={20} />
                    <div className="text-sm leading-relaxed text-text-secondary">
                        <strong className="mb-1 block font-medium text-accent-blue">Security warning</strong>
